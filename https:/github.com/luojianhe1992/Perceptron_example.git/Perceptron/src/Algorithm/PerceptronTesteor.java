...
public class PerceptronTesteor {
	...
	public void loadData() {
		...
		List<double[]> loadData0 = DataLoader
				.loadData("/Users/jianheluo/Desktop/data/label0.dat");
		List<double[]> loadData1 = DataLoader
				.loadData("/Users/jianheluo/Desktop/data/label1.dat");
